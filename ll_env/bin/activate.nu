...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/sushovit/python_workspace/learning_log/ll_env'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/sushovit/python_workspace/learning_log/ll_env/bin/deactivate.nu'
